    ...
    return (
      <div id='about' className='about-me'>
        ...
        <div className='about-pp'>
          <p className='about-line'> I love using code to tell stories and give organizations visibility. It’s powerful and exhilarating. I'm equally ecstatic about using my technical writing background to contribute to writing documentations for
